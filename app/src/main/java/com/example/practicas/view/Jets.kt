...
fun Jets(navController: NavController) {
    ...
    val primaryGreen = Color(0xFF125740)
    val deepGreen = Color(0xFF0A3C2D)
    val tableHeader = Color(0xFF0B2265)
    ...
    LazyColumn(
        ...
        item {
            Row(
                ...
                Icon(
                    painter = painterResource(id = R.drawable.jets), // Cambia si tienes un ícono de flecha
                ...
                Column(modifier = Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
                    ...
                    Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween) {
                        ...
                        Column(horizontalAlignment = Alignment.CenterHorizontally) {
                            ...
                            Text("90", color = Color.White, fontSize = 18.sp, fontWeight = FontWeight.Bold)
                        }
                    }
                }
            }
