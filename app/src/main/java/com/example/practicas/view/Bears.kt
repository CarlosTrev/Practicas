...
fun Bears(navController: NavController) {
    ...
    val juegos = listOf(
        Game("Packers", "21 - 28", "Derrota"),
        Game("Vikings", "24 - 17", "Victoria"),
        Game("Cowboys", "10 - 31", "Derrota"),
        Game("Lions", "27 - 20", "Victoria")
    )

    val jugadores = listOf(
        Player("Justin Fields", "QB", "280 Yds, 2 TD"),
        Player("Roquan Smith", "LB", "12 Tacleadas, 1 INT"),
        Player("Darnell Mooney", "WR", "110 Yds, 1 TD"),
        Player("David Montgomery", "RB", "95 Yds, 1 TD")
    )

    val bearsBlue = Color(0xFF0B162A)
    val bearsOrange = Color(0xFFFF6633)
    val tableHeader = Color(0xFF0B162A)
    val cardGray = Color(0xFF444444)
    ...
    LazyColumn(
        ...
        item {
            Row(
                ...
                Icon(
                    painter = painterResource(id = R.drawable.cb), // pon un ícono de flecha o logo
        ...
        item {
            ...
            Column(
                ...
                Image(
                    painter = painterResource(id = R.drawable.cb),
                    contentDescription = "Bears Logo",
            ...
            LazyRow(horizontalArrangement = Arrangement.spacedBy(12.dp)) {
                items(juegos) { juego ->
                    Card(
                        ...
                        colors = CardDefaults.cardColors(containerColor = bearsBlue),
        ...
        item {
            Card(
                ...
                colors = CardDefaults.cardColors(containerColor = bearsOrange),
                elevation = CardDefaults.cardElevation(defaultElevation = 8.dp)
            ) {
                ...
                Column(modifier = Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
                    ...
                    Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween) {
                        ...
                        Column(horizontalAlignment = Alignment.CenterHorizontally) {
                            ...
                            Text("82", color = Color.White, fontSize = 18.sp, fontWeight = FontWeight.Bold)
                        }
                    }
                }
            }
