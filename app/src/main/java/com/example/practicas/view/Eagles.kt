...
fun Eagles(navController: NavController) {
    ...
    val eaglesGreen = Color(0xFF004C54)
    val midnightGreen = Color(0xFF002244)
    val tableHeader = Color(0xFF004C54)
    val cardGray = Color(0xFF555555)
    ...
    LazyColumn(
        ...
        item {
            Row(
                ...
                Icon(
                    painter = painterResource(id = R.drawable.ea), // Logo o flecha
        ...
        item {
            ...
            Column(
                ...
                Image(
                    painter = painterResource(id = R.drawable.ea),
                    contentDescription = "Eagles Logo",
            ...
            LazyRow(horizontalArrangement = Arrangement.spacedBy(12.dp)) {
                items(juegos) { juego ->
                    Card(
                        ...
                        colors = CardDefaults.cardColors(containerColor = eaglesGreen),
        ...
        item {
            Card(
                ...
                colors = CardDefaults.cardColors(containerColor = midnightGreen),
                elevation = CardDefaults.cardElevation(defaultElevation = 8.dp)
            ) {
                ...
                Column(modifier = Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
                    ...
                    Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween) {
                        ...
                        Column(horizontalAlignment = Alignment.CenterHorizontally) {
                            ...
                            Text("102", color = Color.White, fontSize = 18.sp, fontWeight = FontWeight.Bold)
                        }
                    }
                }
            }
