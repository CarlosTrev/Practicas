...
fun Cowboys(navController: NavController) {
    ...
    val primaryBlue = Color(0xFF003594)
    val deepBlue = Color(0xFF1D428A)
    ...
    LazyColumn(
        ...
        item {
            Row(
                ...
                Icon(
                    painter = painterResource(id = R.drawable.cwb), // pon un ícono de flecha en res/drawable
        ...
        item {
            ...
            Column(horizontalAlignment = Alignment.CenterHorizontally, modifier = Modifier.fillMaxWidth()) {
                Image(
                    painter = painterResource(id = R.drawable.cwb),
                    contentDescription = "Cowboys Logo",
