...
fun Bills(navController: NavController) {
    ...
    val primaryBlue = Color(0xFF00338D)
    val deepBlue = Color(0xFF001F5B)
    ...
    LazyColumn(
        ...
        item {
            Row(
                ...
                Icon(
                    painter = painterResource(id = R.drawable.bills), // Cambia si tienes un icono de flecha
                ...
                Column(modifier = Modifier.padding(16.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
                    ...
                    Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween) {
                        ...
                        Column(horizontalAlignment = Alignment.CenterHorizontally) {
                            ...
                            Text("92", color = Color.White, fontSize = 18.sp, fontWeight = FontWeight.Bold)
                        }
                    }
                }
            }
