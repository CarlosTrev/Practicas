...
fun Cincinati(navController: NavController) {
    ...
    val primaryOrange = Color(0xFFFB4F14)
    val deepOrange = Color(0xFFCC3300)
    val tableHeader = Color(0xFF8B0000)
    ...
    LazyColumn(
        ...
        item {
            Row(
                ...
                Icon(
                    painter = painterResource(id = R.drawable.cincinati), // Cambia si tienes un icono de flecha
        ...
        item {
            ...
            Column(horizontalAlignment = Alignment.CenterHorizontally, modifier = Modifier.fillMaxWidth()) {
                Image(
                    painter = painterResource(id = R.drawable.cincinati),
                    contentDescription = "Cincinati Logo",
                    modifier = Modifier.size(100.dp)
                )
                Spacer(modifier = Modifier.height(12.dp))
                Text(
                    text = "Cincinati Bengals",
                    fontSize = 28.sp,
                    fontWeight = FontWeight.Bold,
                    color = primaryOrange
                )
        ...
        item {
            Card(
                ...
                colors = CardDefaults.cardColors(containerColor = deepOrange),
                elevation = CardDefaults.cardElevation(defaultElevation = 8.dp)
            ) {
